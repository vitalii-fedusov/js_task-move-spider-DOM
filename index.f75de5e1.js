...
const wallInnerHeight = parseFloat(window.getComputedStyle(wall, null).getPropertyValue("height"), 10);
...
document.addEventListener("click", (e)=>{
    ...
    if (newSpiderTop < minSpiderY) newSpiderTop = minSpiderY;
    if (newSpiderTop > maxSpiderY) newSpiderTop = maxSpiderY;
    if (newSpiderLeft < minSpiderX) newSpiderLeft = minSpiderX;
    if (newSpiderLeft > maxSpiderX) newSpiderLeft = maxSpiderX;
